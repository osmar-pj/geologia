<template>
   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="injectedSvg" dataSrc="/icons/moonLandingStrokeRounded.svg" xmlns:xlink="http://www.w3.org/1999/xlink" role="img" color="#000000">
...
<path d="M14.9998 17H15.0088" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
<path d="M12 22C12 20.3431 10.6569 19 9 19C7.34315 19 6 20.3431 6 22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"></path>
