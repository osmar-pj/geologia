<template>
 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="injectedSvg" dataSrc="/icons/mapsLocation01StrokeRounded.svg" xmlns:xlink="http://www.w3.org/1999/xlink" role="img" color="#000000">
...
<path d="M8 2L8 17" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"></path>
<path d="M15 5V9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
...
<path d="M17.5 16.5H17.509" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>
</template>
